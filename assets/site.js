const levels=[{n:'01',ru:'Стратегический',system:'Temporistics',color:'#77e6b3',process:'induction/deduction in temporal and existential experience',q:'same road? жизненная траектория и смысловая рамка'},{n:'02',ru:'Операционный',system:'Psychosophy',color:'#aa8cff',process:'synthesis and analysis in action',q:'run life together? решения, приоритеты, действие'},{n:'03',ru:'Тактический',system:'Socionics',color:'#66d6ff',process:'information modeling / information metabolism',q:'interface fit? восприятие и обмен информацией'}];
...
document.querySelector('#levelCards').innerHTML=levels.map(l=>`<article class="card"><span class="chip" style="color:${l.color}">${l.system}</span><h3>${l.n} · ${l.ru}</h3><p><b>${l.process}</b></p><p>${l.q}</p></article>`).join('');
