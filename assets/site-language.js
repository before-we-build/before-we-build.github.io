(function(root){
  ...
  const TEXT = {
    ru: {
      ...
      'Одна головна біль — три двері.': 'Одна главная боль — три двери.',
      ...
      'Сайт створений насамперед для християн перед серйозними стосунками або шлюбом: для людини, яка ще не в стосунках; для пари, що вже говорить про майбутнє; і для наставника, пастора або батьків, які допомагають без тиску.': 'Сайт создан прежде всего для христиан перед серьёзными отношениями или браком: для человека, который ещё не в отношениях; для пары, которая уже говорит о будущем; и для наставника, пастора или родителей, которые помогают без давления.',
      'Я ще не в стосунках': 'Я ещё не в отношениях',
      ...
      'Before We Build не намагається говорити до всіх однаково. Головна біль проста: як не будувати майбутні стосунки тільки на почуттях, страху самотності, тиску людей або зовнішній «підходящості».': 'Before We Build не пытается говорить ко всем одинаково. Главная боль проста: как не строить будущие отношения только на чувствах, страхе одиночества, давлении людей или внешней «подходящести».',
      ...
      'Для пари важливо не отримати висновок про майбутнє, а назвати відповідальність, очікування, страхи, межі і потребу в пораді до наступного кроку. Кожен проходить питання окремо; потім ви порівнюєте не «хто правильний», а що потрібно принести перед Богом разом.': 'Для пары важно не получить вывод о будущем, а назвать ответственность, ожидания, страхи, границы и потребность в совете до следующего шага. Каждый проходит вопросы отдельно; потом вы сравниваете не «кто правильный», а что нужно принести перед Богом вместе.',
      'Окремо': 'Отдельно',
    ...
    en: {
      ...
      'Одна головна біль — три двері.': 'One main pain — three doors.',
      ...
      'Сайт створений насамперед для християн перед серйозними стосунками або шлюбом: для людини, яка ще не в стосунках; для пари, що вже говорить про майбутнє; і для наставника, пастора або батьків, які допомагають без тиску.': 'The site is made first for Christians before serious relationships or marriage: for a person who is not yet in a relationship; for a couple already speaking about the future; and for a mentor, pastor, or parents helping without pressure.',
      ...
      'Before We Build не намагається говорити до всіх однаково. Головна біль проста: як не будувати майбутні стосунки тільки на почуттях, страху самотності, тиску людей або зовнішній «підходящості».': 'Before We Build does not try to speak to everyone in the same way. The main pain is simple: how not to build future relationships only on feelings, fear of loneliness, pressure from people, or outward “suitability.”',
      ...
      'Для пари важливо не отримати висновок про майбутнє, а назвати відповідальність, очікування, страхи, межі і потребу в пораді до наступного кроку. Кожен проходить питання окремо; потім ви порівнюєте не «хто правильний», а що потрібно принести перед Богом разом.': 'For a couple, the point is not to receive a conclusion about the future, but to name responsibility, expectations, fears, boundaries, and the need for counsel before the next step. Each person answers separately; then you compare not “who is right,” but what should be brought before God together.',
      'Окремо': 'Separately',
  ...
  const META = {
    ...
    '/audiences.html': {
      ru: ['Для кого — перед отношениями или браком', 'Before We Build для христиан перед серьёзными отношениями или браком: личная подготовка, разговор для пары, материалы для наставника, пастора или родителей.'],
